...
class VXA:
    ...
    def __init__(self, HeapSize=0.1, PrintfFIFOSize=50, EnableCilia=0, EnableExpansion=0, DtFrac=0.95, BondDampingZ=1, ColDampingZ=0.8,
                ...
                TempEnabled=0, SavePositionOfAllVoxels=0):
        ...
        self.SavePositionOfAllVoxels = SavePositionOfAllVoxels
    ...
    def set_default_tags(self):
        ...
        etree.SubElement(simulator, "SavePositionOfAllVoxels").text = str(self.SavePositionOfAllVoxels)
