...
plt.plot(list(range(1, gens)), min_err1, color='blue', linestyle='dotted', alpha=0.7)
plt.plot(list(range(1, gens)), max_err1, color='blue', linestyle='dotted', alpha=0.7)
...
plt.plot(list(range(1, gens)), min_err2, color='red', linestyle='dotted', alpha=0.7)
plt.plot(list(range(1, gens)), max_err2, color='red', linestyle='dotted', alpha=0.7)
